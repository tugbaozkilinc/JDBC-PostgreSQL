...
public class CallableStatement01 {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        */
        ...
        Connection con = (Connection) DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "tubA.123");
        ...
        CallableStatement cst1 = con.prepareCall("{? = call toplamaF(?, ?)}"); // Bunun PreparedStatement tan farkı burda return type i da parametre olarak aliyoruz.
